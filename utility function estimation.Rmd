...
# read data
subj_trial_df <- read.csv("./data/preprocessed_data/subj_trial_data.csv")
...
saveRDS(fit_alpha.lambda, file="./res/CPT_no-lambda_c-4_ite-1e4_warm-1e3.rds")
```
...
print(fit_rest, pars = params_rest)
```
